---
title: "Zero Trust x NIST CSF 2.0 Crosswalk"
---

# Zero Trust × NIST CSF 2.0 Crosswalk

> Generated from [`data/nist-csf-mapping.yaml`](../data/nist-csf-mapping.yaml).
> Edit the YAML, not this file.

Maps the [DoD ZT RA 2.0 pillars](../pillars/) — User, Device, Application &
Workload, Data, Network & Environment, Automation & Orchestration,
Visibility & Analytics — against the six [NIST Cybersecurity Framework
(CSF) 2.0](https://www.nist.gov/cyberframework) functions: **Govern,
