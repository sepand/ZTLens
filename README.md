...
- **AWS Marketplace Discovery API** — live, self-serve. Add `AWS_ACCESS_KEY_ID` / `AWS_SECRET_ACCESS_KEY` repo secrets for an IAM user/role with the `AWSMarketplaceDiscoveryFullAccess` policy.
